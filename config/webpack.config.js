...
/** IZENDAMOD
 * IZENDA SPECIFIC MODIFICATION
 * Commenting out ModuleScopePlugin since this sample application will not be using it
 */
...
/** IZENDAMOD
 * IZENDA SPECIFIC MODIFICATION
 * Defining HtmlWebpackExternalsPlugin in order to include the Izenda libraries
 */
...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    entry: [
      ...
      /** IZENDAMOD
       * IZENDA SPECIFIC MODIFICATION
       * WebpackHotDevClient should be commented out to get exports rendering properly
       */
      // isEnvDevelopment &&
    ...
    resolve: {
      ...
      plugins: [
        ...
        /** IZENDAMOD
       * IZENDA SPECIFIC MODIFICATION
       * Commenting ModuleScopePlugin out so that we can custom load the Izenda libraries
       */
    ...
    plugins: [
      ...
      /** IZENDAMOD
       * IZENDA SPECIFIC MODIFICATION
       * Defining the external Webpack plugins for Izenda
       */
